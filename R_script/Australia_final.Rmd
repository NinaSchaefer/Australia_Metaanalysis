...
meta_NvsNI_Australia <- meta %>%
        filter(Status.AUS=="NIS" | Status.AUS=="N")
...
meta_reduced <- subset(meta_reduced, TaxonomicGroup_Status!="Bivalves_NIS") 
...
TaxonomicGroupStatus_orch <-
  orchard_plot(rom.TaxonomicGroupStatus, mod = "TaxonomicGroup_Status", xlab = "Ratio of means", group="Study_Experiment", data=meta_reduced) +  scale_fill_manual(values = g_col) + scale_colour_manual(values = g_col) + theme(axis.text.y = element_text(hjust = 0.95, angle=0)) +
...
ggsave(
 TaxonomicGroupStatus_orch,
  file = "./output/TaxonomicGroupStatus_orch.pdf",
  dpi = plot_dpi,
  width = 10,
  height = 8
)
...
contrast_TaxonomicGroupStatus <- summary(glht(
  ...
  linfct = c(
    "TaxonomicGroup_StatusPolychaetes_N - TaxonomicGroup_StatusPolychaetes_NIS = 0",
    "TaxonomicGroup_StatusBryozoans_N - TaxonomicGroup_StatusBryozoans_NIS = 0",
    "TaxonomicGroup_StatusBarnacles_N - TaxonomicGroup_StatusBarnacles_NIS = 0",
    "TaxonomicGroup_StatusAscidians_N - TaxonomicGroup_StatusAscidians_NIS = 0",
    "TaxonomicGroup_StatusAlgae_N - TaxonomicGroup_StatusAlgae_NIS = 0"
  )
))
...
ggsave(
 FeatureTaxonomicGroup_orch,
  file = "./output/FeatureTaxonomicGroup_orch.pdf",
  dpi = plot_dpi,
  width = 10,
  height = 8
)
...
```{r}
rom.All <- rma.mv( yi, V, mods = ~ TaxonomicGroup_Status +
...
# 
summary(rom.TaxonomicGroupStatus)
...
rom.All.sign <- rma.mv(yi, V, mods = ~ TaxonomicGroup_Status +
                                       Feature_TaxonomicGroup,
                                              random = list(~ 1|Study,
                                                            ~ 1|Effect_ID,
                                                            ~ 1|Species,
...
# TaxonomicGroup_StatusAlgae_NIS                   0.1351  0.2943   0.4592  0.6461  -0.4416   0.7119      
# TaxonomicGroup_StatusAnthozoans_N                0.5168  0.3933   1.3140  0.1889  -0.2541   1.2878      
# TaxonomicGroup_StatusAscidians_N                -0.0908  0.4616  -0.1967  0.8441  -0.9955   0.8139      
# TaxonomicGroup_StatusAscidians_NIS               0.3190  0.2183   1.4614  0.1439  -0.1088   0.7468      
# TaxonomicGroup_StatusBarnacles_N                 0.0371  0.2187   0.1695  0.8654  -0.3917   0.4658      
# TaxonomicGroup_StatusBarnacles_NIS               0.3579  0.2806   1.2752  0.2022  -0.1922   0.9079      
# TaxonomicGroup_StatusBivalves_N                  1.1935  0.7117   1.6770  0.0935  -0.2014   2.5884    . 
# TaxonomicGroup_StatusBivalves_NIS                0.3304  0.3979   0.8302  0.4064  -0.4496   1.1103      
# TaxonomicGroup_StatusBryozoans_N                 0.3772  0.2145   1.7584  0.0787  -0.0432   0.7977    . 
# TaxonomicGroup_StatusBryozoans_NIS               0.2612  0.2020   1.2930  0.1960  -0.1347   0.6571      
# TaxonomicGroup_StatusPolychaetes_N               0.7623  0.2414   3.1579  0.0016   0.2892   1.2355   ** 
# TaxonomicGroup_StatusPolychaetes_NIS             0.4910  0.2742   1.7907  0.0733  -0.0464   1.0285    . 
# TaxonomicGroup_StatusPoriferans_N                0.2556  0.3283   0.7787  0.4362  -0.3878   0.8991      
