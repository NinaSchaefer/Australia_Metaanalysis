...
```{r}
meta<-read.csv("data/Dataset_ Global_nozeros.csv",header=T, fileEncoding="latin1") #read in data
...
write.csv(res_simple.adj_df, file = "./output/ Global_nozeros/summ_simple_adj.csv")
...
simp.adj_orch
ggsave(simp.adj_orch, file = "./output/ Global_nozeros/simp.adj_orch.tiff", dpi = plot_dpi,width = 10, height = 8)

simp.adj_cat <- caterpillars(rom.simple.adj, xlab = "lnRR", group="Study_Experiment", data=meta)
simp.adj_cat
ggsave(simp.adj_cat, file = "./output/ Global_nozeros/simp.adj_cat.tiff", dpi = plot_dpi)
```
...
write.csv(res_res.Feature_TaxonomicGroup_Classification_df, file = "./output/ Global_nozeros/summ_res.Feature_TaxonomicGroup_Classification.csv")
...
ggsave(
 FeatureTaxonomicGroupClassification_orch,
  file = "./output/ Global_nozeros/FeatureTaxonomicGroupClassification_orch.tiff",
  dpi = plot_dpi,
  width = 10,
  height = 8
)
...
ggsave(
 FeatureTaxonomicGroupClassification_orch,
  file = "./output/ Global_nozeros/FeatureTaxonomicGroupClassification_orch.pdf",
  dpi = plot_dpi,
  width = 10,
  height = 8
)
...
FeatureTaxonomicGroupClassification_cat
ggsave(FeatureTaxonomicGroupClassification_cat, file = "./output/ Global_nozeros/FeatureTaxonomicGroupClassification_cat.tiff", dpi = plot_dpi)
...
#save
write.csv(con_df, file = "./output/ Global_nozeros/contrasts_TaxonomicGroupClassification.csv")
```
...
write.csv(res_TaxonomicGroupClassification_df, file = "./output/ Global_nozeros/summ_TaxonomicGroupClassification.csv")
...
ggsave(
 TaxonomicGroupClassification_orch,
  file = "./output/ Global_nozeros/TaxonomicGroupClassification_orch.tiff",
  dpi = plot_dpi,
  width = 10,
  height = 8
)
...
ggsave(
 TaxonomicGroupClassification_orch,
  file = "./output/ Global_nozeros/TaxonomicGroupClassification_orch.pdf",
  dpi = plot_dpi,
  width = 10,
  height = 8
)
...
TaxonomicGroupClassification_cat
ggsave(TaxonomicGroupClassification_cat, file = "./output/ Global_nozeros/TaxonomicGroupClassification_cat.tiff", dpi = plot_dpi)
...
write.csv(res_FeatureClassification_df, file = "./output/ Global_nozeros/summ_FeatureClassification.csv")
...
ggsave(
 FeatureClassification_orch,
  file = "./output/ Global_nozeros/FeatureClassification_orch.tiff",
  dpi = plot_dpi,
  width = 10,
  height = 8
)
...
FeatureClassification_cat
ggsave(FeatureClassification_cat, file = "./output/ Global_nozeros/FeatureClassification_cat.tiff", dpi = plot_dpi)
...
#save
write.csv(con_df, file = "./output/ Global_nozeros/contrasts_FeatureClassification.csv")
```
...
write.csv(res_FeatureTaxonomicGroup_df, file = "./output/ Global_nozeros/summ_FeatureTaxonomicGroup.csv")
...
ggsave(
 FeatureTaxonomicGroup_orch,
  file = "./output/ Global_nozeros/FeatureTaxonomicGroup_orch.tiff",
  dpi = plot_dpi,
  width = 10,
  height = 8
)
...
FeatureTaxonomicGroup_cat
ggsave(FeatureTaxonomicGroup_cat, file = "./output/ Global_nozeros/FeatureTaxonomicGroup_cat.tiff", dpi = plot_dpi)
```
...
jpeg("./output/ Global_nozeros/funnel_simple._adj.jpg",
     width = 600,
     height = 600)
par(cex = 1.4)
...
write.csv(summaries_df, file = "./output/ Global_nozeros/invasives_results.csv")
```