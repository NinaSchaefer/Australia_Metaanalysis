...
# not zero but Study_Experiment and Study_Experiment_Duration (very small effects) - I would remove it
...
rom.FeatureStatus.het <- rma.mv(yi, V, mods = ~ Feature_Status,
                                              random = list(#~ 1|Study, 
                                                            #~ 1|Study_Experiment, # with these things - the model may not run
                                                            #~ 1|Study_Experiment_Duration,
...
#
# 
# rom.FeatureStatus.het2 <- rma.mv(yi, V, mods = ~ Feature_Status,
#                                               random = list(~ 1 + Feature_Status|Study, 
#                                                             #~ 1|Study_Experiment, # with these things - the model may not run
#                                                             #~ 1|Study_Experiment_Duration,
#                                                             ~ 1 + Feature_Status|Effect_ID,
#                                                             ~ 1|Species,
...
# 
# summary(rom.FeatureStatus.het2)
# 
# orchard_plot(rom.FeatureStatus.het2, mod = "Feature_Status", xlab = "Ratio of means (heteroscadasticiy)", group="Study_Experiment") + 
#                      theme(axis.text.y = element_text(angle = 0, hjust = 1))
